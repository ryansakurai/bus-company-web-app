...
<body>
  ...
  <form id="itinerarioForm">
    ...
    <label for="itinerario">Pontos de Parada (id,nome separados por vírgula, conjuntos separados por ponto e vírgula):</label>
    <textarea id="itinerario" name="itinerario" rows="4" required></textarea><br>

    <button type="button" id="cadastrar">Enviar</button>
  </form>
  <footer class="rodape">
